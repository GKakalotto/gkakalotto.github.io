...
const CROPS = {
   /* 每 4 种一组,成熟时间 240/480/720/1440 分钟,组内单位时间收益/经验基本持平;
      每升 4 级进入新一组,单位时间收益/经验随之提高:挂机越久单次收益越高,但锁地更久、种子更贵。
   ...
   bocai:        { name: '菠菜',   cost: 1120, sell: 5600,  grow: 28800, xp: 392,  level: 37 },
