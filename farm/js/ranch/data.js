...
const ANIMAL_PRODUCTS = {
   ...
   luhuaji:    { name: '芦花鸡', sell: 792 },
   guifeiji:   { name: '贵妃鸡', sell: 1584 },
   huoji:      { name: '火鸡', sell: 2376 },
   ya:         { name: '鸭', sell: 4752 },
   e:          { name: '鹅', sell: 873 },
   can:        { name: '蚕', sell: 1746 },
   qiuyin:     { name: '蚯蚓', sell: 2619 },
   ge:         { name: '鸽', sell: 5238 },
   mifeng:     { name: '蜜蜂', sell: 957 },
   woniu:      { name: '蜗牛', sell: 1914 },
   tunshu:     { name: '豚鼠', sell: 2871 },
   mao:        { name: '猫', sell: 5742 },
   gou:        { name: '狗', sell: 1044 },
   ritu:       { name: '肉兔', sell: 2088 },
   cangshu:    { name: '仓鼠', sell: 3132 },
   angelatu:   { name: '安哥拉兔', sell: 6264 },
   mianyang:   { name: '绵羊', sell: 1140 },
   shanyang:   { name: '山羊', sell: 2280 },
   zhu:        { name: '猪', sell: 3420 },
   lv:         { name: '驴', sell: 6840 },
   shuiniu:    { name: '水牛', sell: 1236 },
   huangniu:   { name: '黄牛', sell: 2472 },
   ma:         { name: '马', sell: 3708 },
   nainiu:     { name: '奶牛', sell: 7416 },
   maoniu:     { name: '牦牛', sell: 1341 },
   wuji:       { name: '乌鸡', sell: 2682 },
   anchun:     { name: '鹌鹑', sell: 4023 },
   xiangzhu:   { name: '香猪', sell: 8046 },
   chuiertu:   { name: '垂耳兔', sell: 1449 },
   rouniu:     { name: '肉牛', sell: 2898 },
   aizhongma:  { name: '矮种马', sell: 4347 },
   muyangquan: { name: '牧羊犬', sell: 8694 },
   fanya:      { name: '番鸭', sell: 1560 },
   sanhuangji: { name: '三黄鸡', sell: 3120 },
   huyang:     { name: '湖羊', sell: 4680 },
   tuoniao:    { name: '鸵鸟', sell: 9360 },
   huli:       { name: '狐狸', sell: 1680 },
   meihualu:   { name: '梅花鹿', sell: 3360 },
   luotuo:     { name: '骆驼', sell: 2540 },
   kongque:    { name: '孔雀', sell: 10080 },
};
