...
const ANIMALS = {
   ...
   ya:         { name: '鸭', cost: 3168 , grow: 43200, produceEvery: 7200 , product: 'yap'        , xp: 3294 , level: 4 },
   e:          { name: '鹅', cost: 582  , grow: 7200, produceEvery: 1200 , product: 'ep'         , xp: 576  , level: 5 },
   can:        { name: '蚕', cost: 1164 , grow: 14400, produceEvery: 2400 , product: 'canp'       , xp: 1152 , level: 6 },
   qiuyin:     { name: '蚯蚓', cost: 1746 , grow: 21600, produceEvery: 3600 , product: 'qiuyinp'    , xp: 1728 , level: 7 },
   ge:         { name: '鸽', cost: 3492 , grow: 43200, produceEvery: 7200 , product: 'gep'        , xp: 3456 , level: 8 },
   mifeng:     { name: '蜜蜂', cost: 638  , grow: 7200, produceEvery: 1200 , product: 'mifengp'    , xp: 600  , level: 9 },
   woniu:      { name: '蜗牛', cost: 1276 , grow: 14400, produceEvery: 2400 , product: 'woniup'     , xp: 1200 , level: 10 },
   tunshu:     { name: '豚鼠', cost: 1914 , grow: 21600, produceEvery: 3600 , product: 'tunshup'    , xp: 1800 , level: 11 },
   mao:        { name: '猫', cost: 3828 , grow: 43200, produceEvery: 7200 , product: 'maop'       , xp: 3600 , level: 12 },
   gou:        { name: '狗', cost: 696  , grow: 7200, produceEvery: 1200 , product: 'goup'       , xp: 630  , level: 13 },
   ritu:       { name: '肉兔', cost: 1392 , grow: 14400, produceEvery: 2400 , product: 'ritup'      , xp: 1260 , level: 14 },
   cangshu:    { name: '仓鼠', cost: 2088 , grow: 21600, produceEvery: 3600 , product: 'cangshup'   , xp: 1890 , level: 15 },
   angelatu:   { name: '安哥拉兔', cost: 4176 , grow: 43200, produceEvery: 7200 , product: 'angelatup'  , xp: 3780 , level: 16 },
   mianyang:   { name: '绵羊', cost: 760  , grow: 7200, produceEvery: 1200 , product: 'mianyangp'  , xp: 657  , level: 17 },
   shanyang:   { name: '山羊', cost: 1520 , grow: 14400, produceEvery: 2400 , product: 'shanyangp'  , xp: 1314 , level: 18 },
   zhu:        { name: '猪', cost: 2280 , grow: 21600, produceEvery: 3600 , product: 'zhup'       , xp: 1971 , level: 19 },
   lv:         { name: '驴', cost: 4560 , grow: 43200, produceEvery: 7200 , product: 'lvp'        , xp: 3942 , level: 20 },
   shuiniu:    { name: '水牛', cost: 824  , grow: 7200, produceEvery: 1200 , product: 'shuiniup'   , xp: 687  , level: 21 },
   huangniu:   { name: '黄牛', cost: 1648 , grow: 14400, produceEvery: 2400 , product: 'huangniup'  , xp: 1374 , level: 22 },
   ma:         { name: '马', cost: 2472 , grow: 21600, produceEvery: 3600 , product: 'map'        , xp: 2061 , level: 23 },
   nainiu:     { name: '奶牛', cost: 4944 , grow: 43200, produceEvery: 7200 , product: 'nainiup'    , xp: 4122 , level: 24 },
   maoniu:     { name: '牦牛', cost: 894  , grow: 7200, produceEvery: 1200 , product: 'maoniup'    , xp: 717  , level: 25 },
   wuji:       { name: '乌鸡', cost: 1788 , grow: 14400, produceEvery: 2400 , product: 'wujip'      , xp: 1434 , level: 26 },
   anchun:     { name: '鹌鹑', cost: 2682 , grow: 21600, produceEvery: 3600 , product: 'anchunp'    , xp: 2151 , level: 27 },
   xiangzhu:   { name: '香猪', cost: 5364 , grow: 43200, produceEvery: 7200 , product: 'xiangzhup'  , xp: 4302 , level: 28 },
   chuiertu:   { name: '垂耳兔', cost: 966  , grow: 7200, produceEvery: 1200 , product: 'chuiertup'  , xp: 747  , level: 29 },
   rouniu:     { name: '肉牛', cost: 1932 , grow: 14400, produceEvery: 2400 , product: 'rouniup'    , xp: 1494 , level: 30 },
   aizhongma:  { name: '矮种马', cost: 2898 , grow: 21600, produceEvery: 3600 , product: 'aizhongmap' , xp: 2241 , level: 31 },
   muyangquan: { name: '牧羊犬', cost: 5796 , grow: 43200, produceEvery: 7200 , product: 'muyangquanp', xp: 4482 , level: 32 },
   fanya:      { name: '番鸭', cost: 1040 , grow: 7200, produceEvery: 1200 , product: 'fanyap'     , xp: 780  , level: 33 },
   sanhuangji: { name: '三黄鸡', cost: 2080 , grow: 14400, produceEvery: 2400 , product: 'sanhuangjip', xp: 1560 , level: 34 },
   huyang:     { name: '湖羊', cost: 3120 , grow: 21600, produceEvery: 3600 , product: 'huyangp'    , xp: 2340 , level: 35 },
   tuoniao:    { name: '鸵鸟', cost: 6240 , grow: 43200, produceEvery: 7200 , product: 'tuoniaop'   , xp: 4680 , level: 36 },
   huli:       { name: '狐狸', cost: 1120 , grow: 7200, produceEvery: 1200 , product: 'hulip'      , xp: 813  , level: 37 },
   meihualu:   { name: '梅花鹿', cost: 2240 , grow: 14400, produceEvery: 2400 , product: 'meihualup'  , xp: 1626 , level: 38 },
   luotuo:     { name: '骆驼', cost: 1693 , grow: 21600, produceEvery: 3600 , product: 'luotuop'    , xp: 2439 , level: 39 },
   kongque:    { name: '孔雀', cost: 6720 , grow: 43200, produceEvery: 7200 , product: 'kongquep'   , xp: 4878 , level: 40 },
};
const ANIMAL_PRODUCTS = {
   ...
   luhuaji:    { name: '芦花鸡', sell: 634 },
   guifeiji:   { name: '贵妃鸡', sell: 1267 },
   huoji:      { name: '火鸡', sell: 1901 },
   ya:         { name: '鸭', sell: 3802 },
   e:          { name: '鹅', sell: 698 },
   can:        { name: '蚕', sell: 1397 },
   qiuyin:     { name: '蚯蚓', sell: 2095 },
   ge:         { name: '鸽', sell: 4190 },
   mifeng:     { name: '蜜蜂', sell: 766 },
   woniu:      { name: '蜗牛', sell: 1531 },
   tunshu:     { name: '豚鼠', sell: 2297 },
   mao:        { name: '猫', sell: 4594 },
   gou:        { name: '狗', sell: 835 },
   ritu:       { name: '肉兔', sell: 1670 },
   cangshu:    { name: '仓鼠', sell: 2506 },
   angelatu:   { name: '安哥拉兔', sell: 5011 },
   mianyang:   { name: '绵羊', sell: 912 },
   shanyang:   { name: '山羊', sell: 1824 },
   zhu:        { name: '猪', sell: 2736 },
   lv:         { name: '驴', sell: 5472 },
   shuiniu:    { name: '水牛', sell: 989 },
   huangniu:   { name: '黄牛', sell: 1978 },
   ma:         { name: '马', sell: 2966 },
   nainiu:     { name: '奶牛', sell: 5933 },
   maoniu:     { name: '牦牛', sell: 1073 },
   wuji:       { name: '乌鸡', sell: 2146 },
   anchun:     { name: '鹌鹑', sell: 3218 },
   xiangzhu:   { name: '香猪', sell: 6437 },
   chuiertu:   { name: '垂耳兔', sell: 1159 },
   rouniu:     { name: '肉牛', sell: 2318 },
   aizhongma:  { name: '矮种马', sell: 3478 },
   muyangquan: { name: '牧羊犬', sell: 6955 },
   fanya:      { name: '番鸭', sell: 1248 },
   sanhuangji: { name: '三黄鸡', sell: 2496 },
   huyang:     { name: '湖羊', sell: 3744 },
   tuoniao:    { name: '鸵鸟', sell: 7488 },
   huli:       { name: '狐狸', sell: 1344 },
   meihualu:   { name: '梅花鹿', sell: 2688 },
   luotuo:     { name: '骆驼', sell: 2032 },
   kongque:    { name: '孔雀', sell: 8064 },
};
const ANIMAL_MAX_PRODUCE = 6;      // 动物成熟后可累计产出的次数,满后收获动物本体(产出进度自动累积,不收获也增加)
const ANIMAL_PRODUCE_QTY = 10;     // 每周期产出基准数量
const ANIMAL_PRODUCE_SPREAD = 3;  // 每周期产出随机波动(±),即 7~13
function rollAnimalProduceQty() { return ANIMAL_PRODUCE_QTY - ANIMAL_PRODUCE_SPREAD + Math.floor(Math.random() * (ANIMAL_PRODUCE_SPREAD * 2 + 1)); }
